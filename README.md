...
Para cadastrar uma nova venda pe preciso passar os seguintes parâmetros: {"nomeCliente": "String"}
...
A API também pode ser acessada pelo Swagger, mas antes precisa cadastrar um usuário no postman. http://localhost:8080/swagger-ui/
