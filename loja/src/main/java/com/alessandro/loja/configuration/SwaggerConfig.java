package com.alessandro.loja.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.alessandro.loja.controller"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Loja").description("Projeto de teste pratico para entrevista")
